###In this directory, you will find all the scripts for Shell Permissions:
...
6-multiple_permissions - add execute permission to the owner and the group owner, and read permission to the other users, to the file hello
